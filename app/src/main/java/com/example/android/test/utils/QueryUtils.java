...
public class QueryUtils {
    ...
    /**
     * Return a list of {@link com.example.android.test.models.Quakes} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<Quakes> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<Quakes> quakesList = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < featuresArray.length(); i++){
                ...
                Quakes quakes = new Quakes(magnitude, place, time);
